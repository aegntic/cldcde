...
description: Professional Blender automation for 2D-to-3D transformation and animation
  workflows. Use when converting images to 3D models, creating procedural animations,
  setting up render farms, or automating Blender pipelines with MCP integration.
tags: []
version: 1.0.0

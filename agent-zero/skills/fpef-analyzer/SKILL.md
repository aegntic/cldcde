---
name: fpef-analyzer
description: Systematic Find-Prove-Evidence-Fix framework for complex system analysis
  and intervention. Use when debugging failures, investigating incidents, analyzing
  performance issues, or optimizing complex systems.
tags: []
version: 1.0.0

---
name: bd-management
description: Optimizes Beads workflow activation, parallel processing, and task management.
  Use when working with Beads issues, managing dependencies, or optimizing development
  workflows in projects with complex task dependencies.
tags: []
version: 1.0.0
